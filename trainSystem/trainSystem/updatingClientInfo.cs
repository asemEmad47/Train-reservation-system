...
{
    public partial class updatingClientInfo : Form
    {
        private int ID;
        public updatingClientInfo(int iD)
        {
            InitializeComponent();
            ID = iD;
        }
        ...
        private void updatingClientInfo_Load(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                String query = "UPDATE CLIENT set email = '" + mail + "',username = '" + userName + "' ,password = '" + password + "' where CLIENTID = '"+ID+"'";
                try
                {
                    ...
                    sqlConnection.Close();
                    MessageBox.Show("ur info is updated successfully");
                    textBox1.Clear();
                    textBox2.Clear();
                    textBox3.Clear();
                    textBox4.Clear();
